...
Dolev - this explenation supposed to appear after the plotting
...
Dolev - in general, validate I understood this part
Add specific answer for - "What is the value of the dispersion parameter?"
...
Dolev- add specific answer for - "What is the value of the dispersion parameter?"
and "Judging by the results obtained, do you think that the different untreated and treated samples in
...
Dolev - Add "The expression of `r gene1` shows consistent differences between the control
and treated conditions". Make sure its genes and not gene
```
```{r}
...
Dolev - Make sure its genes and not gene
We did this part differently - check it. Why using the mean here? why this values? I looked for others
Make sure we are answering all questions
...
res
```
Dolev - answer "Does the data we have fit the basic assumptions of DEseq?"
...
Dolev-answer here and not befor code
